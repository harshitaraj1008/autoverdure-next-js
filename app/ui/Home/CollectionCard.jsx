...
const CollectionCard = ({ title, description, image }) => {
  ...
  return (
    <div className="w-fit h-fit md:h-fit p-3 md:p-0 md:flex flex-row-reverse rounded-xl md:rounded-[32.1px] xl:rounded-[56px] md:overflow-hidden bg-[#F8F8F8] border-[2.86px] hover:border-[2.86px] hover:border-primaryMain" onMouseEnter={() => setLineClamp(8)} onMouseLeave={() => setLineClamp(2)}>
      <Image
      ...
      <div className="mt-[16.94px] w-[119px] xl:w-[202px] md:mx-[36.64px] xl:mx-16 xl:mt-[40px]">
        ...
        <div>
          <p className="mt-[8.12px] md:mt-[9.47px] xl:mt-[16.8px] mb-2 md:mb-[5.57px] xl:mb-[10px] text-[8px] md:text-[9.732px] xl:text-[17px] leading-[12.029px] md:leading-[17.174px] xl:leading-[30px] text-[#5B5B5B] font-normal transition-all duration-400 ease-in-out" style={{ display: '-webkit-box', WebkitBoxOrient: 'vertical', WebkitLineClamp: lineClamp, overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {description}
          </p>
        </div>
